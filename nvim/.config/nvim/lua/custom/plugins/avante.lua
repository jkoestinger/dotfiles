local autosuggestions_provider = vim.env.NVIM_AUTOSUGGESTIONS_PROVIDER
...
return {
  ...
  opts = {
    provider = 'mistral',
    auto_suggestions_provider = autosuggestions_provider or 'deepseek',
    claude = {
    ...
    behaviour = {
      auto_suggestions = autosuggestions_provider ~= nil,
    },
    mappings = {
      diff = {
        ours = 'co',
