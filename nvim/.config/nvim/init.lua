...
vim.keymap.set('n', '<C-à>', '<cmd>:cprev<CR>', { desc = 'Move to previous quickfix' })
...
require('lazy').setup({
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      local lexical_config = {
        ...
        cmd = { '/home/justin/bin/lexical/_build/dev/package/lexical/bin/start_lexical.sh' },
        settings = {},
      }
  ...
  --       local disable_filetypes = { c = true, cpp = true, rasi = true }
  --       return {
  --         timeout_ms = 500,
